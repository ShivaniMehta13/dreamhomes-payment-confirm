...
def approve_booking(
    ...
    if stage == "manager":
        ...
        print("MANAGER WEBHOOK STATUS:", resp.status_code)
        print("MANAGER WEBHOOK RESPONSE:", resp.text)
        ...
        print("CR WEBHOOK STATUS:", resp.status_code)
        print("CR WEBHOOK RESPONSE:", resp.text)
